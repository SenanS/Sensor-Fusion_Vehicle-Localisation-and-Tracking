...
Each of the calibration measurements and true measurements were processed using the provided ![](media/f6be5592a3631a9e1d1283f9d5ce1b48.png) function, which converted the signal data into received pulse times for each microphone.

The microphone's cartesian coordinates were:

![](media/f8e3dc0b9e6a08ccb7d623ed1e9d2b2d.png)
...
![](media/ea2e0332bc9faf627af924cefcc39913.png)

Where ![](media/170ef817d4dd0e13113ecbff66af4b09.png) denotes the ![](media/ca9ed8b2e0fadaf3b4ba802d69126801.png) sensor, and ![](media/1d040ff2dd6852f52dbe1f77998d7047.png) denotes the ![](media/ce517a0c12ef0ee96b2371a580911b90.png) measurement. ![](media/a424ee7df2dfed66decee1309dc7e377.png) is the time when the first signal is sent, ![](media/0d38d595f7c14af9c72c5c63c37c5fd9.png) denotes the time interval between two pulses. ![](media/4690fbfdbad59a89c87e78082aef4bea.png) is the time duration of the pulse (pulse width), ![](media/ac2aeedb6d008d73b7fe047d17aa1056.png) is the bias and ![](media/1e0a28962c0cc6990694d2129b9e9c2a.png) is the noise.

First, we use ![](media/bf8d9ff179dd5f217fff834affe98c2d.png) to calculate the interval between two pulse transmissions, and find the average of those values.

After this value is known, we can find the mean value of ![](media/2d2dc1ff1ce4b9260167e620a8718c59.png) for the first sensor if we assume the bias is 0 for this sensor.
...
![](media/90b717509d125d392cc95548d920b9ef.png)
...
![](media/dfb59c7f004847e7d6bc1da91d397634.png)

The first sensor network model created is a 2D 8 Sensor TDOA with a bias state:

![](media/7791bdf7e925ec1b03bc4784a0ca551d.png)
...
![](media/e5fb35683a89284db51c2863632500ad.png)
...
![](media/a228b1fa71a97c25eb967498eea901fa.png)

Where ![](media/69657395f1bf9f36076ffb544c5e6142.png) is the pairwise difference measurements or variance, ![](media/8cd5f862e97a4c9271ac6330c9d90978.png) is the original measurement or variance, m is the number of measurements or variance & n of sensors.
...
![](media/9c9ed3a27d834764768bda45d40bd0df.png)
...
![](media/c14d4a9a9c2a3080f96992b519e372b4.png)
...
![](media/85ec396f00c6a4212b67e7212f03618b.png)
...
![](media/547853185c4b27aa34032471c8dbb5f9.png)
...
![](media/127b11201c80e0052270bbee405bb21d.png)
...
![](media/1433aaab02ea4968cc288b3092933a43.png)
...
![](media/43f88df6f042d3d8f95717a0300454a7.png)

![](media/3afaba1b8b6d23396d4f56ae260be36c.png)
...
![](media/59860a967867dd98eca290fa6da6579b.png)
...
![](media/c57b529848dd55ea222e950bd23a6d10.png)
...
![](media/c422421e3b22b939076c875bba3e394e.png)
